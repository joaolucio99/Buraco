    ...
    void generate_deck(){
        int number_widget[104];
            ...
            for(int i = 0; i < 104; i++ ){ //preenchendo resto das info das cartas
                if( deck[i].suit == 1 ){
                    if( i<2 ) set_deck_infos( "A" , "_Copas.png" , 0 , i, number_widget );
                    ...
                    else if( i>19 && i<22 ) set_deck_infos( "J" , "_Copas.png" , 0 , i, number_widget );
                    else if( i>21 && i<24 ) set_deck_infos( "Q" , "_Copas.png" , 0 , i, number_widget );
                    else if( i>23 && i<26 ) set_deck_infos( "K" , "_Copas.png" , 0 , i, number_widget );
                } else if( deck[i].suit == 2 ){
                    if( i>25 && i<28 ) set_deck_infos( "A" , "_Paus.png" , 0 , i, number_widget );
                    ...
                    else if( i>45 && i<48 ) set_deck_infos( "J" , "_Paus.png" , 0 , i, number_widget );
                    else if( i>47 && i<50 ) set_deck_infos( "Q" , "_Paus.png" , 0 , i, number_widget );
                    else if( i>49 && i<52 ) set_deck_infos( "K" , "_Paus.png" , 0 , i, number_widget );
                } else if( deck[i].suit == 3 ){
                    if( i>51 && i<54 ) set_deck_infos( "A" , "_Espadas.png" , 0 , i, number_widget );
                    ...
                    else if( i>71 && i<74 ) set_deck_infos( "J" , "_Espadas.png" , 0 , i, number_widget );
                    else if( i>73 && i<76 ) set_deck_infos( "Q" , "_Espadas.png" , 0 , i, number_widget );
                    else if( i>75 && i<78 ) set_deck_infos( "K" , "_Espadas.png" , 0 , i, number_widget );
                } else if( deck[i].suit == 4 ){
                    if( i>77 && i<80 ) set_deck_infos( "A" , "_Ouro.png" , 0 , i, number_widget );
                    ...
                    else if( i>97 && i<100 ) set_deck_infos( "J" , "_Ouro.png" , 0 , i, number_widget );
                    else if( i>99 && i<102 ) set_deck_infos( "Q" , "_Ouro.png" , 0 , i, number_widget );
                    else if( i>101 && i<104 ) set_deck_infos( "K" , "_Ouro.png" , 0 , i, number_widget );
                };
            }
    }

    void set_deck_infos( char *number , char *location , int joker , int i, int number_widget[] ){   
        char number_[3], location_[50], final[50], temp_number[4], temp[50];
